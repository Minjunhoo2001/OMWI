...
script_dir <- "/share/home/HeMinjun/metagenomic/GitHub/scripts"
...
defaults <- list(
  raw_dir = "/share/home/HeMinjun/metagenomic/GitHub/data/02.by_level",
  batch_dir = "/share/home/HeMinjun/metagenomic/GitHub/data/03.batch_train",
  meta_dir = "/share/home/HeMinjun/metagenomic/GitHub/data/01.split",
  out_dir = "/share/home/HeMinjun/metagenomic/GitHub/results/Supplementary_Figure_1",
  level = "species",
...
adonis_adj_disease <- run_permanova(
  adj_pcoa$dist,
  meta_use,
  paste0("`", DISEASE_VAR, "`"),
  permutations = PERM_N
...
adonis_adj_system <- run_permanova(
  adj_pcoa$dist,
  meta_use,
  paste0("`", SYSTEM_VAR, "`"),
  permutations = PERM_N
...
disease_levels <- levels(meta_use[[DISEASE_VAR]])
batch_levels <- levels(meta_use[[BATCH_VAR]])

disease_cols <- make_disease_colors(disease_levels)
